...
public class CategoryConfiguration : IEntityTypeConfiguration<Category>
{
    public void Configure(EntityTypeBuilder<Category> builder)
    {
        ...
        builder.HasOne(category => category.Owner).WithMany().HasForeignKey(category => category.OwnerId).OnDelete(DeleteBehavior.Restrict).HasConstraintName("fk_categories_users_owner_id");
