...
public class StatisticsViewModel
{
    ...
    public IReadOnlyList<StatisticsMainCategoryViewModel> ExpenseMainCategories { get; init; } = [];
...
public record StatisticsMainCategoryViewModel(Guid? Id, string Name, decimal Amount, string IconPath, string IconAlt, IReadOnlyList<StatisticsSubcategoryViewModel> Subcategories);
public record StatisticsSubcategoryViewModel(Guid? Id, string Name, decimal Amount);
