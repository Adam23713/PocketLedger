...
public record PlannerAccountBalance(Guid Id, string Name, string Currency, bool IncludeInMainBalance, decimal CurrentBalance, decimal OpeningBalance, decimal ClosingBalance, bool UseCurrentBalance = true, decimal? CustomOpeningBalance = null)
{
...
public record PlannerOpeningBalance(Guid AccountId, bool UseCurrentBalance, decimal? Amount);
public record PlannerOpeningBalanceInput(bool UseCurrentBalance, decimal? Amount);
