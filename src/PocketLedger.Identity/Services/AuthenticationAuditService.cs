...
public sealed class AuthenticationAuditService(IdentityDbContext dbContext, IHttpContextAccessor contextAccessor, IClientIpAddressResolver clientIpAddressResolver, ILogger<AuthenticationAuditService> logger) : IAuthenticationAuditService
{
