...
public class DebtConfiguration : IEntityTypeConfiguration<Debt>
{
    public void Configure(EntityTypeBuilder<Debt> builder)
    {
        ...
        builder.Property(debt => debt.Name).HasColumnName("name").HasColumnType("text").IsRequired();
        ...
        builder.Property(debt => debt.CounterpartyName).HasColumnName("counterparty_name").HasColumnType("text").IsRequired();
        ...
        builder.Property(debt => debt.Note).HasColumnName("note").HasColumnType("text");
